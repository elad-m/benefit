...
public class CategoryScreen {
    ...
    private Map<Category, FrameLayout> categoryButtonMap;
...
//    }
    ...
    private void addCategory(TableRow tableRow, int index) {
        FrameLayout categoryFrame = new FrameLayout(view.getContext());
        ...
        categoryFrame.setLayoutParams(lp);
...
//            }
//        });
        addImage(categoryFrame, index);
        addText(categoryFrame, index);
        tableRow.addView(categoryFrame);
        categoryButtonMap.put(category.get(index), categoryFrame);
    }
...
//        image.setImageDrawable(convertStringToDrawable(category.getNames().get(index)));
    ...
    public Map<Category, FrameLayout> getCategoryButtonMap() {
